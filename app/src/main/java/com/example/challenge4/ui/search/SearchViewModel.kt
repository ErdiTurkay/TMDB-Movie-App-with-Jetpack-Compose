...
class SearchViewModel @Inject constructor(
    ...
    private val _searchMovieList: MutableState<List<Movie>> = mutableStateOf(mutableListOf())
    val searchMovieList: State<List<Movie>> = _searchMovieList
    ...
    fun getSearchMovies(query: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                _searchMovieList.value = movieList
